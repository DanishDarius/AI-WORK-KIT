...
Connecteurs, Skills, Plugins, MCP, Agents, mode arrière-plan, livrables structurés, mémoire longue durée. Un lexique simple des termes IA les plus courants, sans charabia.

## Pourquoi ce lexique

Ces mots reviennent partout, rarement définis proprement. Voici un dico simple, en français.
...
Il n'est pas nécessaire de tout maîtriser, seulement de reconnaître ces quinze mots. Garder ce lexique sous la main : le rouvrir deux ou trois fois suffit généralement à tout éclaircir.
