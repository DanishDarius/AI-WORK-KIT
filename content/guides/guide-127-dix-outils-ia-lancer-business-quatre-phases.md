...
Acheter tous les outils dès le premier jour. Seuls Claude et une idée validée sont nécessaires pour démarrer. Le reste vient une fois les premiers clients acquis.

## À retenir

**Un outil par phase, pas dix à la fois.**

La pile d'outils grandit avec le chiffre d'affaires. Au début, moins c'est mieux : la clarté gagnée compense largement les fonctionnalités en moins.
