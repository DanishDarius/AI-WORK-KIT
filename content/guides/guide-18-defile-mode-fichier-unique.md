...
| 5 | Publier | 15 min | Mettre en ligne le fichier unique et le brancher sur votre nom → une URL que vous pouvez envoyer |

---

## 02. Comprendre : pourquoi ce projet et pas un autre

La plupart des démonstrations IA que l'on croise sont des dashboards. Personne ne les regarde vraiment. Un défilé, si. C'est visuel, ça se comprend en dix secondes, et surtout ça démontre trois choses à la fois : vous savez diriger une IA sur un rendu exigeant, vous savez respecter une contrainte technique difficile, et vous savez livrer un résultat concret.
...
**Durée :** 30 min
**Vous produisez :** 5 à 8 images verticales, plein pied, fond blanc pur
...
Aucune caméra, aucun casting, aucun studio nécessaire. Vous générez vos silhouettes avec un modèle d'image IA performant (comme le modèle image de Gemini). La seule chose qui compte réellement : la cohérence entre les différents visuels. Même cadrage, même lumière, même distance, même hauteur de sol. Sinon, le couloir de perspective laisse voir la supercherie.
...
> Tenue : [décrivez la pièce, la matière et les chaussures]
>
...
*Générez la première image, validez le cadrage, puis réutilisez-la comme référence pour les suivantes en ne changeant que la tenue. C'est la façon la plus simple de tenir la cohérence sur l'ensemble des visuels. Nommez vos fichiers dans l'ordre (01, 02, 03...), car le brief les classe par ordre alphabétique.*

*Vous ne voulez pas générer d'images vous-même ? Le brief prévoit ce cas de figure : sans média, le site se construit quand même, avec des silhouettes en aplat de couleur qui se comportent exactement comme des clips vidéo. Vous les remplacez plus tard, sans toucher au code.*
...
**Durée :** 25 min
**Vous produisez :** des .mp4 H.264, yuv420p, faststart, sans piste audio
...
Passez chaque image dans un modèle image vers vidéo (Veo, Kling, Runway, au choix) avec une consigne minimale : le mannequin marche vers la caméra, celle-ci ne bouge pas, le fond reste blanc, cinq secondes, boucle propre. Rien de plus. Plus vous demandez d'effets supplémentaires, plus le fond dérive et plus le cadrage devient visible.
...
*Ensuite, huit vidéos qui tournent simultanément, ça se paie en performance. Réduisez le côté long à 900 px et supprimez l'audio avec cette commande :*
```
...
**Durée :** 5 min
**Vous produisez :** le fichier .md collé, plus une consigne de cadrage
...
**Durée :** 30 min
**Vous produisez :** une page qui passe la checklist du brief
...
*Ce plafond de quinze lignes est l'un des meilleurs garde-fous qui existent sur un fichier unique. Sans lui, l'agent a tendance à réécrire toute la page à chaque tour, et vous perdez ce qui fonctionnait déjà.*
...
**Durée :** 15 min
**Vous produisez :** une URL, et une deuxième version à votre propre nom
**Le piège à éviter :** s'arrêter à la version démo. C'est joli, mais ça ne vend rien en soi.

Un fichier unique se met en ligne partout en trente secondes. Passez ensuite à la vraie version : le même couloir, mais avec vos propres clips. Cinq extraits de conférence, cinq formats de contenu, cinq offres commerciales. Le clic n'ouvre plus une simple fiche produit, mais une véritable page de vente. Vous venez de vous fabriquer un portfolio que personne d'autre ne possède.
...
Ouvrez la page sur votre téléphone, en 4G, devant quelqu'un qui ne sait pas ce que vous avez fait. S'il attrape spontanément le téléphone pour cliquer sur un mannequin, c'est réussi. S'il vous demande comment vous avez fait, c'est gagné.
...
Le brief prévoit un mode de repli : des silhouettes en aplat de couleur qui bougent, réagissent au survol et s'ouvrent au clic comme de vraies vidéos. Vous les remplacez plus tard, sans toucher au code.
...
Ce qui produit ce site, ce n'est pas une phrase magique. C'est un document de 263 lignes qui ne laisse aucune place à l'interprétation. Prenez l'habitude : avant de demander quoi que ce soit de sérieux à une IA, rédigez d'abord le fichier de spécification complet. Vous passerez vingt minutes de plus au démarrage, mais vous économiserez trois heures d'allers-retours inutiles.
