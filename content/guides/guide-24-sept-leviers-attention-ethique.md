...
>
> La valeur concrète que je veux livrer : [CE QUE LES GENS SAURONT FAIRE APRÈS].
>
> Écris-moi 5 premières phrases qui ouvrent une boucle ouverte : chacune doit poser une question implicite dont MA valeur ci-dessus est la réponse exacte.
>
> Interdit : promettre plus que ce que je livre, ou un faux suspense sans réponse.
>
> Pour chaque option, indique en une ligne où et comment la boucle se referme dans le post.
...
>
> Donne-moi la MÊME idée déclinée en 6 formats de « récompense » différents : 1) un chiffre qui surprend, 2) une mini-histoire vécue, 3) un raccourci actionnable, 4) un contre-exemple qui détruit une croyance, 5) une métaphore visuelle, 6) une question qui retourne le sujet.
>
> Chaque déclinaison doit livrer une vraie valeur, jamais juste teaser.
...
>
> Donne-moi 5 ancrages d'ouverture possibles : soit un chiffre réel et vérifiable lié au sujet, soit une affirmation tranchée qui pose une nouvelle échelle de référence.
>
> Pour chaque ancrage, dis ce qu'il fait paraître plus grand, plus urgent ou plus simple ensuite.
>
...
>
> Transforme-le en parcours numéroté clair (étapes ou niveaux), du plus simple au plus avancé.
>
> Pour chaque étape : un titre court, le mini-résultat obtenu, et une phrase qui situe la personne (« tu es à l'étape X, il te reste Y »). Le but : qu'elle voie sa propre progression.

Outil : ChatGPT ou Claude pour la structure ; Canva pour rendre la barre de progression visible sur un carrousel.
...
>
> Liste 7 moments concrets et 7 émotions réelles où cette personne vit ce problème (heure de la journée, situation, sensation). Pour chaque, écris une accroche qui nomme ce moment précis et enchaîne sur ma solution.
>
> Interdit : inventer une peur qui n'existe pas. Pars uniquement de situations vécues.
...
La récompense que je promets, est-ce que je la livre vraiment ?

Mon point d'arrêt final laisse-t-il la personne libre et orientée, pas dans le vide ?

Mon ancrage (chiffre, affirmation) est-il vrai et vérifiable ?

Ma preuve sociale est-elle réelle, sans chiffre gonflé ?

Ma progression aide-t-elle SA compétence, pas seulement mon temps de visionnage ?

Mon déclencheur part-il d'une situation qu'elle vit déjà, sans fabriquer d'angoisse ?

---

## À retenir

**Même mécanique, intention inverse : c'est ça qui sépare la manipulation de la valeur.**

Un casino utilise ces sept leviers pour que le joueur perde et que la maison gagne. Utilisés ici, ils servent à ce qu'une audience reparte avec quelque chose en plus à chaque contenu. Le test des 60 secondes, passé avant chaque publication, garde ces leviers du bon côté de la ligne.
