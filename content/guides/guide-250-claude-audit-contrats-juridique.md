...
Repérer les clauses problématiques : une clause de non-concurrence abusive, une clause de propriété intellectuelle défavorable, des pénalités déguisées. Ce type de repérage reste sa vraie force.

## Ce que l'outil fait mal

Conseiller sur un point de droit local très spécifique. Sur le fiscal, le social ou le contentieux, l'avis d'un professionnel reste indispensable. L'IA fonctionne comme un radar de repérage, pas comme un avocat.
...
>
> Donne-moi :
> 1. Les 5 clauses les plus risquées POUR MOI, classées par danger
> 2. Pour chacune : pourquoi c'est risqué, et la reformulation à proposer
> 3. Les 3 clauses qui MANQUENT et que je devrais demander
> 4. Le verdict global : signable / négociable / à fuir
>
> Sois cash. Pas de "il conviendrait de noter que".
